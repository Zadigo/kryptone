...
class BaseStorage:
    ...
    is_connected: bool = Literal[False]
...
class PostGresStorage(BaseStorage):
    ...
    storage_connection: psycopg.Connection = ...
    ...
    @staticmethod
    def comma_join(fields) -> str: ...

    @staticmethod
    def quote_value(value) -> str: ...

    @staticmethod
    def finalize(value) -> str: ...

    def quote_values(self, *values) -> str: ...

    def build_condition(self, **params) -> str: ...

    def join_tokens(self, *tokens, finalize_each=False) -> str: ...

    def initialize(self) -> None: ...

    def select_sql(self, table) -> str: ...

    def create_sql(self, table, column, value) -> str: ...

    def insert_sql(self, table, columns=[], values=[]) -> str: ...

    def run_sql_statements(self, *tokens) -> Any: ...

    def save(self, key, data, adapt_list=False, **kwargs) -> Any: ...

    # def visited_urls(self, state=True) -> Any: ...

    def insert_sql(
        self, 
        table: str, *
        values: List[str | URL | float | int]
    ) -> str: ...
