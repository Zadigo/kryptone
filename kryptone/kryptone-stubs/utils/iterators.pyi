...
from typing import AsyncGenerator, Generator, List, Literal, Union, DefaultDict


def drop_null(
    items, remove_empty_strings: bool = ...) -> Generator[str, None, None]: ...
...
class PagePaginationGenerator:
    ...
    def __len__(self) -> int: ...
    def __add__(self, obj: PagePaginationGenerator) -> CombinedIterators: ...
