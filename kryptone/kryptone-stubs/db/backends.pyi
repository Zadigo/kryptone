...
class SQL:
    ...
    @staticmethod
    def simple_join(values: List[str],
                    space_characters: bool = ...) -> str: ...
...
class Query:
    ...
    def __init__(self, backend: SQLiteBackend,
                 sql_tokens: list[str], table: Table = ...): ...

    def __repr__(self) -> str: ...
    def __del__(self) -> None: ...
    @classmethod
    def run_multiple(cls, backend, *sqls, **kwargs) -> Generator[Query]: ...
    @classmethod
    def create(cls, backend, sql_tokens, table=None) -> Query: ...
    def prepare_sql(self) -> None: ...
    def run(self, commit=False) -> None: ...
