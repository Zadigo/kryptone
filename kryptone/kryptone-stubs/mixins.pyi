...
from typing import Any, DefaultDict, List, Literal, Tuple, Union
...
class SEOMixin(TextMixin):
    ...
    def get_internal_urls(self, audit: dict[str, Any]) -> None: ...

    def audit_images(self, audit: dict[str, Any]) -> Tuple[int, set[str]]: ...
    def audit_structured_data(self, audit: dict[str, Any]) -> Tuple[bool, dict]: ...

    def vectorize_documents(self) -> Tuple: ...
    def vectorize_page(self, text: str) -> Tuple: ...
...
class EmailMixin(TextMixin):
    ...
    def find_emails_from_links(self, elements: List[WebElement]) -> set[str]: ...
