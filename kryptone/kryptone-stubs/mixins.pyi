...
class SEOMixin(TextMixin):
    ...
    def create_graph(self, current_url: URL,
                     x_values: list[str], y_values: list[int]) -> None: ...
    def calculate_word_frequency(
        self, tokens: list[str]) -> tuple[FreqDist, list[str, int]]: ...
    ...
    def audit_page_status_code(self, audit: dict) -> None: ...
    def audit_page(
        self, current_url: Union[URL, str], generate_graph: bool = ...) -> dict: ...
